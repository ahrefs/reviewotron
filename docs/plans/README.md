...
| Plan | Focus | Status |
|------|-------|--------|
| [Pluggable Review Architecture](2026-05-25-pluggable-review-architecture.md) | Split source adapters, core review engine, and sink adapters while keeping GitHub behavior working at each stage | Stage 2 complete |
