...
let make_pr_payload ?(action = "opened") ?(number = 42) ?(title = "Add feature X to the dashboard")
  ...
  "pull_request": {
    ...
    "title": %S,
    "body": %S,
    "html_url": "https://github.com/ahrefs/monorepo/pull/%d",
    "diff_url": "https://github.com/ahrefs/monorepo/pull/%d.diff",
    "state": "open",
    "draft": %s,
    "merged": false,
    "labels": [],
...
let make_push_payload ?(ref_ = "refs/heads/develop") ?(before = "fb245e2a6d52d10025c8bd4f36f6e3134d85ae18")
  ...
  let commit_json =
    Printf.sprintf
      ...
      "url": "https://github.com/ahrefs/monorepo/commit/%s",
  ...
  "head_commit": %s,
  "repository": %s,
  "compare": "https://github.com/ahrefs/monorepo/compare/%s...%s",
